...
def main() -> None:
    ...
    # Philly, Helios, Mooncake CI fixtures are 100 rows; tighten train/eval in smoke mode.
    if smoke and args.trace in ("philly", "helios", "mooncake"):
